...
var difficulty_levels = ["Łatwy", "Normalny", "Trudny"]
var current_difficulty = 1;
func _on_difficulty_left_arrow_pressed() -> void:
	if(current_difficulty>0):
		current_difficulty-=1
		UserPreferences.set_setting("general", "difficulty_level", current_difficulty)
		difficulty_label.text = difficulty_levels[current_difficulty]
...
func _on_difficulty_right_arrow_pressed() -> void:
	if(current_difficulty<difficulty_levels.size()-1):
		current_difficulty+=1
		UserPreferences.set_setting("general", "difficulty_level", current_difficulty)
		difficulty_label.text = difficulty_levels[current_difficulty]
...
var screen_modes = [{"displayed_name":"Okno", "value":"window"}, 
					{"displayed_name":"Okno bez ramek", "value":"window_borderless"}, 
					{"displayed_name":"Pełny ekran", "value":"fullscreen"}];
var current_screen_mode_index = 1;
...
var current_resolution_index = 7;
